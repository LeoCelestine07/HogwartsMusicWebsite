...
DEFAULT_SITE_CONTENT = {
    ...
    "services_page_subtitle": "From dubbing to mastering, we offer comprehensive audio post-production services tailored to your creative vision.",
    "services_cta_title": "Not Sure Which Service You Need?",
    "services_cta_subtitle": "Let's discuss your project and find the perfect solution for your audio needs.",
    ...
    "about_page_description": "Hogwarts Music Studio is a professional audio post-production facility dedicated to delivering exceptional sound experiences. From dubbing and mixing to full music production, we bring technical expertise and creative vision to every project.",
    "about_philosophy_title": "Our Philosophy",
    "about_philosophy_text": "We believe that great sound is invisible — it doesn't call attention to itself but instead amplifies the emotional impact of every scene, every note, every word. Our mission is to be the sonic architects behind your creative vision.",
    ...
    "about_cta_subtitle": "Ready to elevate your project with professional audio? We'd love to hear from you.",
    ...
    "founder_section_title": "The Vision Behind Hogwarts",
    ...
    "founder_imdb_text": "View on IMDb",
    # Stats Section
    "stat1_value": "6+",
